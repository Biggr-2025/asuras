...
const DraggableRow = ({ row }: { row: Row<IProduct> }) => {
...
export default function ProductsList({
	...
	const bannerImage = bannerData?.data?.group || ({} as IBannerImage);
	...
	const handleDeleteProduct = useCallback(
		async (productId: string) => {
			...
			// 	IApiResponse<{ group: IBannerImage }>
			// 	;
			...
			const latestBannerData = queryClient.getQueryData([
				...
				activeId,
				bannerId,
			]) as IApiResponse<{ group: IBannerImage }>;
