export enum Routes {
	...
	AddDepartment = '/product-utils/departments',
	AddCategory = '/product-utils/category',
	AddSubCategory = '/product-utils/sub-category',
	AddBrands = '/product-utils/brands',
	EditUtils = '/product-utils/edit',
}
